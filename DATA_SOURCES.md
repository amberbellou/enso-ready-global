...
| Crop calendars | FAO/GIEWS crop calendars | FAO | static | *pending endpoint confirmation* | FAO (CC BY-NC-SA or open, to confirm) | – | – |
...
| Vulnerability (internal) | INFORM Risk Index | JRC / IASC | yearly | *pending endpoint confirmation* | CC BY 4.0 (to confirm) | – | one calm context line max |
